    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	...
            	<form class="form-horizontal" method="POST" action="posicion_add.php">
                ...
                <div class="form-group">
                    <label for="sueldo" class="col-sm-3 control-label">Pago por Hora</label>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="posicion_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_sueldo" class="col-sm-3 control-label">Costo por Hora</label>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="posicion_delete.php">
            		<input type="hidden" id="del_posid" name="id">
            		<div class="text-center">
	                	<p>ELIMINAR POSICIÓN</p>
	                	<h2 id="del_posicion" class="bold"></h2>
	            	</div>
          	</div>
