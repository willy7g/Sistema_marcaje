          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, empleado.empleado_id AS empid, asistencia.id AS attid FROM asistencia LEFT JOIN empleado ON empleado.id=asistencia.empleado_id ORDER BY asistencia.date DESC, asistencia.time_in DESC";
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#asistencia_date').html(response.date);
