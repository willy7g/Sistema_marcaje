          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, overtime.id AS otid, empleado.empleado_id AS empid FROM overtime LEFT JOIN empleado ON empleado.id=overtime.empleado_id ORDER BY date_overtime DESC";
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#horas_edit').val(hour);
      $('#mins_edit').val(min);
      $('#sueldo_edit').val(response.sueldo);
    }
  });
}
</script>
